...
class OptimizationLoop:
    """Repeat full search sweeps while they still improve deployment."""
    ...
    def run(
        ...
        *,
        ...
        for iteration_index in range(1, policy.max_iterations + 1):
            ...
            # Exhausting Screen points does not imply that all persisted
            # challengers have received a Formal comparison.  Let the same
            # deployment-patience rule govern both fresh and historical
            # evidence instead of stopping immediately at Screen exhaustion.
